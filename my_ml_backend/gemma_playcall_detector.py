...
class GemmaDetector:
    ...
    def _load_gemma(self):
        ...
        bnb_config = BitsAndBytesConfig(
            ...
            llm_int8_enable_fp32_cpu_offload=True,  # 允许 auto 把放不下的层 offload 到 CPU
        )

        processor = AutoProcessor.from_pretrained(model_path)

        print("加载模型 (int4, device_map=auto)...")
